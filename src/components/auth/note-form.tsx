...
import { formSchema } from '@/schemas/notes-schema';
import { FormValues } from '@/domain/types/types';
...
import { TagsInput } from '../notes/tags-input';
import { ColorPicker } from '../notes/colors-picker';
...
export function NoteForm({ noteId }: NoteFormProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: isEditing && noteId ? getNote(noteId) : {
      title: '',
      content: '',
      tags: [],
      color: '#ffffff',
            ...
            <FormItem>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[500px]">
                ...
                <div className="h-full border rounded-md overflow-auto p-4 bg-gray-50 dark:bg-gray-900">
                  <MarkdownPreview content={field.value || '*Pré-visualização..*'} />
                </div>
              </div>
              <FormMessage />
            </FormItem>
